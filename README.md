...
<h3 align="center">Simexid ionic-barcode-scanner</h3>
<p align="center">Simexid fork for ionic of original Barcode Scanner</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@simexid/ionic-barcode-scanner"><img src="https://img.shields.io/npm/l/@simexid/ionic-barcode-scanner?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/@simexid/ionic-barcode-scanner"><img src="https://img.shields.io/npm/dw/@simexid/ionic-barcode-scanner?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/@simexid/ionic-barcode-scanner"><img src="https://img.shields.io/npm/v/@simexid/ionic-barcode-scanner?style=flat-square" /></a>
...
All releases of this package can be found on [npm](https://www.npmjs.com/package/@simexid/ionic-barcode-scanner?activeTab=versions) and on [GitHub Releases](https://github.com/capacitor-community/barcode-scanner/releases)

## Installation

```bash
npm install @simexid/ionic-barcode-scanner
npx cap sync
```
...
```js
import { BarcodeScanner } from '@simexid/ionic-barcode-scanner';
...
```ts
import { BarcodeScanner, SupportedFormat } from '@simexid/ionic-barcode-scanner';
